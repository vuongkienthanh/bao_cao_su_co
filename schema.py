...
class Related(str, Enum):
    nham_lan_thong_tin_benh_nhan = "Nhầm lẫn thông tin bệnh nhân"
    truyen_nham_nhom_mau_va_cac_che_pham_mau = "Truyền nhấm máu và các chế phẩm máu"
    phau_thuat_sai_benh_nhan_vi_tri = "Phẫu thuật sai bệnh nhân, vị trí"
    giao_nham_thuoc = "Giao nhầm thuốc"
    gui_mau_xet_nghiem_sai_quy_dinh = "Gửi mẫu xét nghiệm sai quy định"
    chat_luong_thuoc_vat_tu_tieu_hao_khong_dam_bao = "Chất lượng thuốc, vật tư tiêu hao không đảm bảo"
    ke_sai_toa_thuoc = "Kê sai toa thuốc"
    benh_nhan_te_nga = "Bệnh nhân té ngã"
    tran_nha_san_nha_hu_sut_lun = "Trần nhà, sàn nhà hư, sụt lún"
    trang_thiet_bi_vat_tu_y_te_hu_loi = "Trang thiết bị, vật tư y tế hư lỗi"
    thiet_thuoc_vat_tu_y_te_noi_ngoai_tru = "Thiếu thuốc, vật tư y tế nội ngoại trú"
    phan_mem_his_labcon_bi_hu_loi = "Phần mềm HIS, Labcon bị hư lỗi"
    khac = "Khác"
